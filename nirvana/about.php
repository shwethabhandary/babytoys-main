...
<html lang="en">
  ...
  <body class="goto-here">
    <nav class="navbar navbar-expand-lg navbar-dark ftco_navbar bg-dark ftco-navbar-light" id="ftco-navbar">
	    <div class="container">
	      <a class="navbar-brand" style="color: #3f358f;"href="index.php">Nirvana</a>
	      ...
	      <div class="collapse navbar-collapse" id="ftco-nav">
	        <ul class="navbar-nav ml-auto">
				<ul class="navbar-nav ml-auto">
					...
					<li class="nav-item active" style="color: #3f358f;"><a href="about.php" class="nav-link" style="color: #3f358f;">About</a></li>
			...
			<div class="container">
	          ...
	          <div class="pb-md-5">
	          	<p>While there’s no big bad wolf coming to blow your house or business down, it stands true that some building materials are better suited for your project than others. Today, most structures are composed of wood, steel, concrete, or masonry. Each material has its own strengths and weaknesses that should be considered..</p>
							...
							<p><a href="product.php" class="btn" style="background-color: #3f358f;">View Catalog</a></p>
						</div>
				</div>
			</div>
		</section>
          ...
          <div class="col-md-6 col-lg-4 ftco-animate">
            <div class="product">
              ...
              <div class="text py-3 pb-4 px-3 text-center">
                ...
                <div class="d-flex">
                  <div class="pricing">
                    <p class="price"><span style="color: #3f358f;">
                    <?php echo $lines[1]; ?>
                    <br/>
                    <?php echo $lines[2]; ?>
                    </span></p>
          ...
          <div class="col-md-6 col-lg-4 ftco-animate">
            <div class="product">
              ...
              <div class="text py-3 pb-4 px-3 text-center">
                ...
                <div class="d-flex">
                  <div class="pricing">
                    <p class="price"><span style="color: #3f358f;"><?php echo $lines[5]; ?><br/><?php echo $lines[6]; ?></span></p>
                  </div>
                </div>
              </div>
            </div>
          ...
          <div class="col-md-6 col-lg-4 ftco-animate">
            <div class="product">
              ...
              <div class="text py-3 pb-4 px-3 text-center">
                ...
                <div class="d-flex">
                  <div class="pricing">
                    <p class="price"><span style="color: #3f358f;"><?php echo $lines[9]; ?><br/><?php echo $lines[10]; ?></span></p>
                  </div>
                </div>
              </div>
            </div>
